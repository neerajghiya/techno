...
public class DownloadFiles {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		fileContent = FileUtil.readFile("D:\\MiscBillBug\\ListLogs.html");
		...
		//   System.out.println(m.group(0));
		  // System.out.println(m.group(1));
		   ...
		   if(link.indexOf("mbhoisnapp859.usfdc.corpintra.net:10000/logview/downloadservlet?filename=") > 0){
			   list.add(link);
		   }
		}
		...
		for (String string : list) {
			...
			String destination = "D:\\MiscBillBug\\downloads";
