...
public class OnlineLeadsDBFailureCronService {
	public static void main(String[] args) throws IOException {
		OnlineLeadsDBFailureCronService cronService = new OnlineLeadsDBFailureCronService();
	...
	private void readAndRunFailureFiles() throws IOException {
		...
		String failureFilePath = "/usr/appdata/share/eai/starLead/onlineLead/failure";
	...
	private static List readCSVFile() throws IOException {
		...
		Calendar cal = Calendar.getInstance();
		try {
			File file = new File(csvFilePath + "/" + dateFormat.format(cal.getTime()) + "/onlineDBFailureLeads.csv");
			if (file.exists()) {
				System.out.println("File exists");
	...
	private static void updateFile(String lead, boolean appendComma) throws IOException{
		...
		try {
			FileWriter file = new FileWriter(csvFilePath + "/"
					+ dateFormat.format(cal.getTime()) + "/onlineDBFailureLeads.csv", true);
			if (appendComma) {
				file.append(",");
			}
			file.append(lead);
